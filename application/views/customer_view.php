...
<body>
    <div class="container">
        <h1 style="font-size:20pt">Test TheFthing</h1>
...
$('#t').DataTable( {
        ajax:  {
          url: 'http://localhost/ajaxngerest/index.php/CustomerApi',
...
$(document).ready(function() {
	...
	$('#table').DataTable( {
        dom: "Bfrtip",
        //ajax: "http://localhost/ajaxngerest/index.php/CustomerApi",
		ajax: {
            "url": "http://localhost/ajaxngerest/index.php/CustomerApi",
            "type": "POST"
        },
...
function edit_customer(id)
{
    ...
    $.ajax({
        ...
        success: function(data)
        {
			...
			$('[name="is_married"]').val(data.is_married);
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
						...
						<div class="form-group">
                            <label class="control-label col-md-3">Married</label>
                            <div class="col-md-9">
